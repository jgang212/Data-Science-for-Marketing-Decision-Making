...
From the table, we can see that the maximum profitability point is when Tide's price is decreased by 5% and Gain's price is increased by 5%. Of course, since this is the edge of our percentage delta range, it's possible that we can decrease Tide's price further and/or increase Gain's price further for more profits. However, it's probably prudent to start with smaller price changes and looking at the analysis in the future with new data, in case the current model does not predict well outside of 5% price changes.
